...
def sample_trajectory(env, policy, max_path_length, render=False):
    ...
    while True:
        ...
        forward_input = np.expand_dims(ob, axis = 0)
        ac_distribution = policy.forward(torch.tensor(forward_input, dtype = torch.float32))
        ac_sample = ac_distribution.sample() # HINT: this is a numpy array
        ac = ac_sample.numpy()[0]
